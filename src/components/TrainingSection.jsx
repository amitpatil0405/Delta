...
export default function TrainingSection() {
  ...
  return (
    <section id="training" className="relative pt-8 sm:pt-10 pb-16 scroll-mt-16 sm:scroll-mt-20 bg-transparent bg-subpage-grid border-t border-white/5 overflow-hidden">
