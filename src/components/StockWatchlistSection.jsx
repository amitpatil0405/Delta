  ...
  return (
    <section className="py-16 bg-[#050505] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-400 max-w-xl">
              Track equities across core Indian market sectors: Finance, IT, Oil & Gas, FMCG, and Automobile with live quotes and candlestick charting.
            </p>
          </div>
        </div>
        ...
        {/* Fixed Sector Watchlist Section */}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-center">
                        <button
                          onClick={() => setActiveSymbol(stock.symbol)}
                          className="px-3 py-1 text-[11px] font-bold bg-amber-500/20 text-amber-400 border border-amber-500/40 rounded-lg hover:bg-amber-500 hover:text-black transition-all uppercase"
                        >
                          VIEW CHART
                        </button>
                      </td>
